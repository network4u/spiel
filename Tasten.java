...
/**
 * Tasten ist die Klasse die für alle Tasten auf dem Bildschirm verantwortlich ist,
 * die mit der Maus angeklickt werden können und deren Funktion
 * (die Aktionen die ausgelöst werden).
 * 
...
class Tasten extends Menue
{
    ...
    /**
     * Legt den Faktor für die Vergrößerung der Methode mausScale() fest.
     */
    ...
    /**
     * Sorgt dafür, dass sich der Regler, der für die Lautstärke zuständig ist,
     * bewegen lässt.
     */
